...
CONCISE paragraph: at most 1,200 characters, which is `registry/pdp-dr-instruction.md`'s gate for
them and well under the band below. Every other type keeps slot form.

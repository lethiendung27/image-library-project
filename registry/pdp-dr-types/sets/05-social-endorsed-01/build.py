...
"tôi chưa thấy thợ rửa xe lưu động, cư dân trang phục không phù hợp cho rửa xe". Round 3 landed every
clause the type owns and the owner passed the type (ADR-116).

CORRECTION, 2026-09-21 (ADR-117): earlier headers of this file said the renders held "a brass
garden-hose nozzle rather than the attached product", 9 of 9. That was wrong. The reference photo was
opened on 2026-09-21 and the product IS a black pistol-grip spray gun with a brass nozzle collar, a
trigger and a brass hose fitting at the foot of the grip. Every render carried the attached product.
...
A("")
A("**Type:** `05-social-endorsed`, written at 0.3 and rendered there (ADR-115). The type has since been "
  "**promoted to active at 1.0** on these renders (ADR-116) and corrected to 1.1 (ADR-117); no prompt "
  "text changed, so the headings below still read v0.3 — the version these three were sent at. "
  "**Status: COMMITTED with the promotion.** GENERATED by this folder's `build.py` — edit the script, "
  "never this file.")
A("")
...
A("")
A("**The product was never wrong — the grading was** (ADR-117). Nine renders across three rounds were "
  "marked down for holding \"a brass garden-hose nozzle\" instead of the `Cordless Car Wash Tool`. The "
  "owner confirmed the photo was attached every time; it was then downloaded from the page's own "
  "gallery URL and opened, `sha256:ff37a23b…`, the hash this set declares. **The product IS a black "
  "pistol-grip spray gun with a brass nozzle collar, a trigger, a brass hose fitting at the foot of the "
...
A("")
A(f"**Attach the product photo:** `{PHOTO}`. The owner attaches it every render, and nine renders show "
  "it arriving: the tool in frame is the tool in the photo.")
A("")
A("## Watch items")
A("")
A("1. Is the thing in the hand the attached product — the black gun with the brass collar and the brass "
  "fitting at the foot of the grip? Hold the reference photo beside the render before answering.")

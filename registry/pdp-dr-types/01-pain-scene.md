...
## CHANGELOG
- 1.18 (2026-09-15): copied verbatim from `registry/types/01-pain-scene.md` at 1.18, commit `3cabeab` — owner instruction, ADR-091. Every section except WORKED EXAMPLES and CHANGELOG is that file's text. The version is the parent's; this file's own edits bump it from here.

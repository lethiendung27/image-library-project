...
| **wondering why a rule exists** | `decisions/log.md`, append-only, 98 ADRs, every one cites its evidence |
...
- **LP2's own drafts route nothing** (2026-09-15) — `registry/pdp-dr-types/` routes only its
  seventeen copies of the active image types (ADR-091) and one type copied from the toplist
  namespace (ADR-097). Its sixteen drafts are fourteen

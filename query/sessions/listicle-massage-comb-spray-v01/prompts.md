...
- ratio `1:1` · type version `1.16` · upload the product photo · `register: commercial`, `inset_mode: detail`, `inset_motion: still`
...
```
listicle-proof-massage-comb-spray-v01.mp4
...
```
listicle-mechanism-massage-comb-spray-v01.mp4
3s · 1:1 · seamless loop · mp4, muted, loop-safe, under the size ceiling
...
```
listicle-use-massage-comb-spray-v01.mp4
4s · 1:1 · seamless loop · mp4, muted, loop-safe, under the size ceiling

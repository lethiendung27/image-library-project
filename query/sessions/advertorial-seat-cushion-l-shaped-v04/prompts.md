...
```
advertorial-cause-seat-cushion-l-shaped-v04.mp4
...
- ratio `16:9` · type version `1.16` · upload the product photo · `register: commercial`, `inset_mode: detail`, `inset_motion: loop`
...
- ratio `16:9` · type version `1.16` · upload the product photo · `register: commercial`, `inset_mode: detail`, `inset_motion: still`
...
```
advertorial-mechanism-seat-cushion-l-shaped-v04.mp4
3s · 1:1 · seamless loop · mp4, muted, loop-safe, under the size ceiling
...
```
advertorial-relief-seat-cushion-l-shaped-v04.mp4

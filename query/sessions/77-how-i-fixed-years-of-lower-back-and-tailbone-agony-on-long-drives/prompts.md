...
- page `77` · advertorial · solution-aware · registry `2.0.0` · 11 routed slots · 27 prompts
...
### problems.items.0.image · option D — the motion brief plate

- gif type `cause` · form `whole-frame` · rung `natural`
- reference folder: gifs-library/cause/ — no files filed yet; the folder card carries the law
- **the editor returns** `77-02-problem0-pain-scene.mp4` · mp4/webm, muted, under the size ceiling
- plate render asset `77-02-problem0-pain-scene--brief.png` — production only, never a page asset
...
### features.items.2.image · option D — the motion brief plate

- gif type `proof` · form `whole-frame` · rung `re-execution`
- reference folder: gifs-library/proof/ — no files filed yet; the folder card carries the law
- **the editor returns** `77-06-feature2-proof-lockedframe.mp4` · mp4/webm, muted, under the size ceiling
- plate render asset `77-06-feature2-proof-lockedframe--brief.png` — production only, never a page asset

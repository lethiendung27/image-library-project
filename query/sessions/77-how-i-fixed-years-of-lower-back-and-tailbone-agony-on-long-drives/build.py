...
BRIEF_PROB0 = """The driver's seat from the open door at standing height, the old fixes still on it and no product in frame, in the still's flat overcast daylight. Under braking the pad creeps to the front lip and the lumbar roll drops into the seat-corner crack, opening the gap behind the pelvis wider."""

BRIEF_FEAT2 = """One continuous frame and no panels: the reference cushion filling the same driver's seat through the same open door, in the still's overcast daylight and neutral grade. The weight lifts away out of shot, the slow-rebound contour rises back to full depth at the seat corner, then presses down again."""
...
PAGE_NOTES = [
    ...
    "slot's ratio, and a brief of TWO SENTENCES (ADR-029, band 25-55 words). The plates are "
    "GENERATED by scripts/gen-plate.py "
